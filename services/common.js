         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           <tr>
             <td align="center" valign="top" style="padding: 36px 24px;">
               <a href="https://e-commerce-site-sibun.vercel.app" target="_blank" style="display: inline-block;">
                 <img src="https://drive.google.com/file/d/1-nlYcYDUoc172WiRDmPKnkocBt5jMCEW/view?usp=drive_link" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
               </a>
             </td>
           </tr>
         </table>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           ...
           <tr>
             <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
               <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="nayak.ecommerce@gmail.com">contact us</a>.</p>
             </td>
           </tr>
           <!-- end copy -->
           <!-- start receipt table -->
                 ...
                 <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                   <tr>
                     <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                       ...
                       <p>${order.selectedAddress.number}</p>
                       </td>
                   </tr>
                 </table>
               </div>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           ...
           <tr>
             <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
               <p style="margin: 0;">You received this email because we received a request from your account. If you didn't request then Raise a Complaint at our Site <a href="https://e-commerce-site-sibun.vercel.app">click here</a> or you can safely Ignore this email.</p>
             </td>
           </tr>
           <!-- end permission -->
           <!-- start unsubscribe -->
           <tr>
             <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
               <p style="margin: 0;">To stop receiving these emails, you can <a href="https://e-commerce-site-sibun.vercel.app" target="_blank">unsubscribe</a> at any time.</p>
               <p style="margin: 0;">State-Odisha, Dist-Ganjam, City-Berhampur, Pin-761008</p>
             </td>
           </tr>
           <!-- end unsubscribe -->
         </table>
